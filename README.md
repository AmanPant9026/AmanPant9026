...
- Hit **88.98% recall** on shipping-bill benchmarks — on par with GPT (85.04%), at a fraction of the cost

**📊 Synthetic Financial Data — American Express** &nbsp;·&nbsp; *Jun 2025–Present*
> ₹1 Crore research collaboration on fraud & default detection
- Benchmarked **CTGAN, TVAE, FinDiff & TabSyn** on fidelity (Shape, Trend), utility (C2ST), and privacy (α-Precision, β-Recall, DCR)
- Diffusion model achieved **95.89 C2ST · 96.49 α-Precision**, DCR near the 50% privacy threshold

**🧠 Brain Tumor Progression** &nbsp;·&nbsp; *Jan–Jun 2025*
- Automated **BraTS-Pro pipeline** for longitudinal MRI tumour progression analysis
- **Siamese 3D-CNN** achieving **88% accuracy & 90% recall**, built to support reliable clinical assessments over time

**🎙️ Voice of the Nation — Language Identification** &nbsp;·&nbsp; *Apr 2025*
> 🥈 2nd place among 300+ teams — HCL AI Hackathon @ IIT Mandi
- 10-language speech classifier using **Wav2Vec XLS-R 300M + OpenL3** with Orthogonal Projection Loss → **82% accuracy**
- SVM gender classification module → **99% accuracy**

**⚡ Hybrid Cache Replacement Policy** &nbsp;·&nbsp; *Oct–Dec 2024*
- Smart block-replacement policy in **MacSIM** for hybrid volatile/non-volatile cache systems
- **45% reduction in power consumption** vs SRAM-only caches
...
![Prompt Engineering](https://img.shields.io/badge/Prompt%20Engineering-BB2ACF?style=flat-square&logoColor=white)

**RAG Systems**
![Vectored RAG](https://img.shields.io/badge/Vectored%20RAG-6A0DAD?style=flat-square&logoColor=white)
![Vectorless RAG](https://img.shields.io/badge/Vectorless%20RAG-7B2FBE?style=flat-square&logoColor=white)
![Self--Corrective RAG](https://img.shields.io/badge/Self--Corrective%20RAG-9B30FF?style=flat-square&logoColor=white)
